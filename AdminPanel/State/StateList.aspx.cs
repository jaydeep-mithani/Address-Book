...
public partial class States_View : System.Web.UI.Page
{
    #region Page Load
    ...
    private void DeleteRecord(int id)
    {
        ...
        try
        {
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "PR_State_DeleteRowByPK";
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Make sure this entry is not linked to any other records.')", true);
        }
        finally
        {
            con.Close();
