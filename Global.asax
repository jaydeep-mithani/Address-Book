...
<script runat="server">
    ...
    public static void RegisterRoutes(System.Web.Routing.RouteCollection routes)
    {
        ...
        routes.MapPageRoute("AdminPanelLogin", "AdminPanel/Login", "~/Content/LoginForm.aspx");
        routes.MapPageRoute("AddressBookSignup", "AddressBook/Signup", "~/AdminPanel/Users/UserSignup.aspx");
